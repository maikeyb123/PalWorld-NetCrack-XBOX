...
namespace Offsets
{
	constexpr int32 GObjects          = 0x089D2700;
	constexpr int32 AppendString      = 0x02E41560;
	constexpr int32 GNames            = 0x08933000;
	constexpr int32 GWorld            = 0x08B40320;
	constexpr int32 ProcessEvent      = 0x02FC3E40;
